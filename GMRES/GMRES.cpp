...
int main()
{
    ...
    while (NormTemp > NormZero) {
        ...
        for (int j = 0; j < m; j++)
        {
            //6 stage
            vector<double> rho;
            vector<double> rho_ = Matrix_K_ByVec(matrix_K, teta[j]);
